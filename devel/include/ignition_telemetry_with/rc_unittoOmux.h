// Generated by gencpp from file ignition_telemetry_with/rc_unittoOmux.msg
// DO NOT EDIT!


#ifndef IGNITION_TELEMETRY_WITH_MESSAGE_RC_UNITTOOMUX_H
#define IGNITION_TELEMETRY_WITH_MESSAGE_RC_UNITTOOMUX_H
...
struct rc_unittoOmux_
{
  ...
  typedef boost::shared_ptr< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> const> ConstPtr;

}; // struct rc_unittoOmux_

typedef ::ignition_telemetry_with::rc_unittoOmux_<std::allocator<void> > rc_unittoOmux;

typedef boost::shared_ptr< ::ignition_telemetry_with::rc_unittoOmux > rc_unittoOmuxPtr;
typedef boost::shared_ptr< ::ignition_telemetry_with::rc_unittoOmux const> rc_unittoOmuxConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator1> & lhs, const ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5a9878d79a5dbdeeULL;
  static const uint64_t static_value2 = 0xdaf385d69bb9ad39ULL;
};

template<class ContainerAllocator>
struct DataType< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ignition_telemetry_with::rc_unittoOmux_<ContainerAllocator>& v)
  {
...
#endif // IGNITION_TELEMETRY_WITH_MESSAGE_RC_UNITTOOMUX_H
