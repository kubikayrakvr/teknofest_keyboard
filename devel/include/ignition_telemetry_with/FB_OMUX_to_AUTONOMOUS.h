// Generated by gencpp from file ignition_telemetry_with/FB_OMUX_to_AUTONOMOUS.msg
// DO NOT EDIT!


#ifndef IGNITION_TELEMETRY_WITH_MESSAGE_FB_OMUX_TO_AUTONOMOUS_H
#define IGNITION_TELEMETRY_WITH_MESSAGE_FB_OMUX_TO_AUTONOMOUS_H
...
struct FB_OMUX_to_AUTONOMOUS_
{
  ...
  typedef boost::shared_ptr< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> const> ConstPtr;

}; // struct FB_OMUX_to_AUTONOMOUS_

typedef ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<std::allocator<void> > FB_OMUX_to_AUTONOMOUS;

typedef boost::shared_ptr< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS > FB_OMUX_to_AUTONOMOUSPtr;
typedef boost::shared_ptr< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS const> FB_OMUX_to_AUTONOMOUSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator1> & lhs, const ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7068cf9bccd4d479ULL;
  static const uint64_t static_value2 = 0x7668be13f6b90cbbULL;
};

template<class ContainerAllocator>
struct DataType< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ignition_telemetry_with::FB_OMUX_to_AUTONOMOUS_<ContainerAllocator>& v)
  {
...
#endif // IGNITION_TELEMETRY_WITH_MESSAGE_FB_OMUX_TO_AUTONOMOUS_H
