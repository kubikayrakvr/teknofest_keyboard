...
(cl:defmethod cl:initialize-instance :after ((m <rc_unittoOmux>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rc_unittoOmux)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<rc_unittoOmux> is deprecated: use ignition_telemetry_with-msg:rc_unittoOmux instead.")))

(cl:ensure-generic-function 'AUTONOMOUS_EMERGENCY-val :lambda-list '(m))
(cl:defmethod AUTONOMOUS_EMERGENCY-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:AUTONOMOUS_EMERGENCY-val is deprecated.  Use ignition_telemetry_with-msg:AUTONOMOUS_EMERGENCY instead.")
...
(cl:defmethod RC_WindowResintance-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_WindowResintance-val is deprecated.  Use ignition_telemetry_with-msg:RC_WindowResintance instead.")
...
(cl:defmethod RC_InteriorLight-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_InteriorLight-val is deprecated.  Use ignition_telemetry_with-msg:RC_InteriorLight instead.")
  (RC_InteriorLight m))

(cl:ensure-generic-function 'RC_ReverseLight-val :lambda-list '(m))
(cl:defmethod RC_ReverseLight-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_ReverseLight-val is deprecated.  Use ignition_telemetry_with-msg:RC_ReverseLight instead.")
  (RC_ReverseLight m))

(cl:ensure-generic-function 'RC_DRL-val :lambda-list '(m))
(cl:defmethod RC_DRL-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_DRL-val is deprecated.  Use ignition_telemetry_with-msg:RC_DRL instead.")
  (RC_DRL m))

(cl:ensure-generic-function 'RC_BrakeLight-val :lambda-list '(m))
(cl:defmethod RC_BrakeLight-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_BrakeLight-val is deprecated.  Use ignition_telemetry_with-msg:RC_BrakeLight instead.")
  (RC_BrakeLight m))

(cl:ensure-generic-function 'AUTONOMOUS_DOOR_OPEN-val :lambda-list '(m))
(cl:defmethod AUTONOMOUS_DOOR_OPEN-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:AUTONOMOUS_DOOR_OPEN-val is deprecated.  Use ignition_telemetry_with-msg:AUTONOMOUS_DOOR_OPEN instead.")
...
(cl:defmethod AUTONOMOUS_DOOR_CLOSE-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:AUTONOMOUS_DOOR_CLOSE-val is deprecated.  Use ignition_telemetry_with-msg:AUTONOMOUS_DOOR_CLOSE instead.")
...
(cl:defmethod RC_SignalStatus-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_SignalStatus-val is deprecated.  Use ignition_telemetry_with-msg:RC_SignalStatus instead.")
  (RC_SignalStatus m))

(cl:ensure-generic-function 'RC_LowBeam-val :lambda-list '(m))
(cl:defmethod RC_LowBeam-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_LowBeam-val is deprecated.  Use ignition_telemetry_with-msg:RC_LowBeam instead.")
  (RC_LowBeam m))

(cl:ensure-generic-function 'RC_HighBeam-val :lambda-list '(m))
(cl:defmethod RC_HighBeam-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_HighBeam-val is deprecated.  Use ignition_telemetry_with-msg:RC_HighBeam instead.")
  (RC_HighBeam m))

(cl:ensure-generic-function 'RC_SelectionGear-val :lambda-list '(m))
(cl:defmethod RC_SelectionGear-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_SelectionGear-val is deprecated.  Use ignition_telemetry_with-msg:RC_SelectionGear instead.")
  (RC_SelectionGear m))

(cl:ensure-generic-function 'RC_Ignition-val :lambda-list '(m))
(cl:defmethod RC_Ignition-val ((m <rc_unittoOmux>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:RC_Ignition-val is deprecated.  Use ignition_telemetry_with-msg:RC_Ignition instead.")
  (RC_Ignition m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rc_unittoOmux>)))
  ...
  "ignition_telemetry_with/rc_unittoOmux")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rc_unittoOmux)))
  "Returns string type for a message object of type 'rc_unittoOmux"
  "ignition_telemetry_with/rc_unittoOmux")
