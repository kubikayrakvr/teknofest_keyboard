...
(cl:defmethod cl:initialize-instance :after ((m <FB_OMUX_to_AUTONOMOUS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FB_OMUX_to_AUTONOMOUS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<FB_OMUX_to_AUTONOMOUS> is deprecated: use ignition_telemetry_with-msg:FB_OMUX_to_AUTONOMOUS instead.")))

(cl:ensure-generic-function 'FB_EMERGENCY-val :lambda-list '(m))
(cl:defmethod FB_EMERGENCY-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_EMERGENCY-val is deprecated.  Use ignition_telemetry_with-msg:FB_EMERGENCY instead.")
  (FB_EMERGENCY m))

(cl:ensure-generic-function 'FB_ReverseLight-val :lambda-list '(m))
(cl:defmethod FB_ReverseLight-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ReverseLight-val is deprecated.  Use ignition_telemetry_with-msg:FB_ReverseLight instead.")
  (FB_ReverseLight m))

(cl:ensure-generic-function 'FB_RightSignal-val :lambda-list '(m))
(cl:defmethod FB_RightSignal-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_RightSignal-val is deprecated.  Use ignition_telemetry_with-msg:FB_RightSignal instead.")
  (FB_RightSignal m))
...
(cl:defmethod FB_WindowResistance-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_WindowResistance-val is deprecated.  Use ignition_telemetry_with-msg:FB_WindowResistance instead.")
...
(cl:defmethod FB_LeftSignal-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_LeftSignal-val is deprecated.  Use ignition_telemetry_with-msg:FB_LeftSignal instead.")
  (FB_LeftSignal m))

(cl:ensure-generic-function 'FB_InteriorLight-val :lambda-list '(m))
(cl:defmethod FB_InteriorLight-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_InteriorLight-val is deprecated.  Use ignition_telemetry_with-msg:FB_InteriorLight instead.")
  (FB_InteriorLight m))

(cl:ensure-generic-function 'FB_DRL-val :lambda-list '(m))
(cl:defmethod FB_DRL-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_DRL-val is deprecated.  Use ignition_telemetry_with-msg:FB_DRL instead.")
  (FB_DRL m))

(cl:ensure-generic-function 'FB_DoorKeyStatus-val :lambda-list '(m))
(cl:defmethod FB_DoorKeyStatus-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_DoorKeyStatus-val is deprecated.  Use ignition_telemetry_with-msg:FB_DoorKeyStatus instead.")
  (FB_DoorKeyStatus m))

(cl:ensure-generic-function 'FB_BrakeLight-val :lambda-list '(m))
(cl:defmethod FB_BrakeLight-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_BrakeLight-val is deprecated.  Use ignition_telemetry_with-msg:FB_BrakeLight instead.")
  (FB_BrakeLight m))

(cl:ensure-generic-function 'FB_BatteryVoltage-val :lambda-list '(m))
(cl:defmethod FB_BatteryVoltage-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_BatteryVoltage-val is deprecated.  Use ignition_telemetry_with-msg:FB_BatteryVoltage instead.")
  (FB_BatteryVoltage m))

(cl:ensure-generic-function 'FB_ChargeInput-val :lambda-list '(m))
(cl:defmethod FB_ChargeInput-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ChargeInput-val is deprecated.  Use ignition_telemetry_with-msg:FB_ChargeInput instead.")
  (FB_ChargeInput m))

(cl:ensure-generic-function 'FB_HighBeam-val :lambda-list '(m))
(cl:defmethod FB_HighBeam-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_HighBeam-val is deprecated.  Use ignition_telemetry_with-msg:FB_HighBeam instead.")
  (FB_HighBeam m))

(cl:ensure-generic-function 'FB_LowBeam-val :lambda-list '(m))
(cl:defmethod FB_LowBeam-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_LowBeam-val is deprecated.  Use ignition_telemetry_with-msg:FB_LowBeam instead.")
  (FB_LowBeam m))

(cl:ensure-generic-function 'FB_IGNITION-val :lambda-list '(m))
(cl:defmethod FB_IGNITION-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_IGNITION-val is deprecated.  Use ignition_telemetry_with-msg:FB_IGNITION instead.")
  (FB_IGNITION m))

(cl:ensure-generic-function 'FB_HazardousLight-val :lambda-list '(m))
(cl:defmethod FB_HazardousLight-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_HazardousLight-val is deprecated.  Use ignition_telemetry_with-msg:FB_HazardousLight instead.")
  (FB_HazardousLight m))

(cl:ensure-generic-function 'FB_VehicleStatus-val :lambda-list '(m))
(cl:defmethod FB_VehicleStatus-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_VehicleStatus-val is deprecated.  Use ignition_telemetry_with-msg:FB_VehicleStatus instead.")
  (FB_VehicleStatus m))

(cl:ensure-generic-function 'FB_LeftDoorStatus-val :lambda-list '(m))
(cl:defmethod FB_LeftDoorStatus-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_LeftDoorStatus-val is deprecated.  Use ignition_telemetry_with-msg:FB_LeftDoorStatus instead.")
  (FB_LeftDoorStatus m))
...
(cl:defmethod FB_RightDoorStatus-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_RightDoorStatus-val is deprecated.  Use ignition_telemetry_with-msg:FB_RightDoorStatus instead.")
...
(cl:defmethod FB_BatterySOC-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_BatterySOC-val is deprecated.  Use ignition_telemetry_with-msg:FB_BatterySOC instead.")
  (FB_BatterySOC m))
...
(cl:defmethod FB_ErrorPowerTrain-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ErrorPowerTrain-val is deprecated.  Use ignition_telemetry_with-msg:FB_ErrorPowerTrain instead.")
...
(cl:defmethod FB_ErrorBattery-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ErrorBattery-val is deprecated.  Use ignition_telemetry_with-msg:FB_ErrorBattery instead.")
  (FB_ErrorBattery m))
...
(cl:defmethod FB_BrakePedal_Voltage_EN-val ((m <FB_OMUX_to_AUTONOMOUS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_BrakePedal_Voltage_EN-val is deprecated.  Use ignition_telemetry_with-msg:FB_BrakePedal_Voltage_EN instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FB_OMUX_to_AUTONOMOUS>)))
  ...
  "ignition_telemetry_with/FB_OMUX_to_AUTONOMOUS")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FB_OMUX_to_AUTONOMOUS)))
  "Returns string type for a message object of type 'FB_OMUX_to_AUTONOMOUS"
  "ignition_telemetry_with/FB_OMUX_to_AUTONOMOUS")
