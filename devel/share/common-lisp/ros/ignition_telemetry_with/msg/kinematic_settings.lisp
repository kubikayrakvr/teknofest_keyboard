...
(cl:defmethod cl:initialize-instance :after ((m <kinematic_settings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'kinematic_settings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<kinematic_settings> is deprecated: use ignition_telemetry_with-msg:kinematic_settings instead.")))

(cl:ensure-generic-function 'kinematics-val :lambda-list '(m))
(cl:defmethod kinematics-val ((m <kinematic_settings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:kinematics-val is deprecated.  Use ignition_telemetry_with-msg:kinematics instead.")
  (kinematics m))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <kinematic_settings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:enable-val is deprecated.  Use ignition_telemetry_with-msg:enable instead.")
  (enable m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<kinematic_settings>)))
  ...
  "ignition_telemetry_with/kinematic_settings")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'kinematic_settings)))
  "Returns string type for a message object of type 'kinematic_settings"
  "ignition_telemetry_with/kinematic_settings")
