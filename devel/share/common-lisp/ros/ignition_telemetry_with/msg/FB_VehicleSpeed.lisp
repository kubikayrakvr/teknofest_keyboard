...
(cl:defmethod cl:initialize-instance :after ((m <FB_VehicleSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FB_VehicleSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<FB_VehicleSpeed> is deprecated: use ignition_telemetry_with-msg:FB_VehicleSpeed instead.")))

(cl:ensure-generic-function 'FB_VehicleSpeed_KMh-val :lambda-list '(m))
(cl:defmethod FB_VehicleSpeed_KMh-val ((m <FB_VehicleSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_VehicleSpeed_KMh-val is deprecated.  Use ignition_telemetry_with-msg:FB_VehicleSpeed_KMh instead.")
...
(cl:defmethod FB_ReelVehicleSpeed_KMh-val ((m <FB_VehicleSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ReelVehicleSpeed_KMh-val is deprecated.  Use ignition_telemetry_with-msg:FB_ReelVehicleSpeed_KMh instead.")
...
(cl:defmethod FB_ReelVehicleSpeed_Ms-val ((m <FB_VehicleSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:FB_ReelVehicleSpeed_Ms-val is deprecated.  Use ignition_telemetry_with-msg:FB_ReelVehicleSpeed_Ms instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FB_VehicleSpeed>)))
  ...
  "ignition_telemetry_with/FB_VehicleSpeed")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FB_VehicleSpeed)))
  "Returns string type for a message object of type 'FB_VehicleSpeed"
  "ignition_telemetry_with/FB_VehicleSpeed")
