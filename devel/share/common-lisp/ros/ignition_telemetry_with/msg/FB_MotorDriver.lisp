...
(cl:defmethod cl:initialize-instance :after ((m <FB_MotorDriver>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FB_MotorDriver)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<FB_MotorDriver> is deprecated: use ignition_telemetry_with-msg:FB_MotorDriver instead.")))
...
(cl:defmethod GEAR_STATUS_FROM_MOTOR-val ((m <FB_MotorDriver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:GEAR_STATUS_FROM_MOTOR-val is deprecated.  Use ignition_telemetry_with-msg:GEAR_STATUS_FROM_MOTOR instead.")
...
(cl:defmethod PlusTripDistance-val ((m <FB_MotorDriver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:PlusTripDistance-val is deprecated.  Use ignition_telemetry_with-msg:PlusTripDistance instead.")
  (PlusTripDistance m))

(cl:ensure-generic-function 'VehicleRPM-val :lambda-list '(m))
(cl:defmethod VehicleRPM-val ((m <FB_MotorDriver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:VehicleRPM-val is deprecated.  Use ignition_telemetry_with-msg:VehicleRPM instead.")
  (VehicleRPM m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FB_MotorDriver>)))
  ...
  "ignition_telemetry_with/FB_MotorDriver")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FB_MotorDriver)))
  "Returns string type for a message object of type 'FB_MotorDriver"
  "ignition_telemetry_with/FB_MotorDriver")
