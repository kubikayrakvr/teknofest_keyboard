...
(cl:defmethod cl:initialize-instance :after ((m <kinematic_messages>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'kinematic_messages)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ignition_telemetry_with-msg:<kinematic_messages> is deprecated: use ignition_telemetry_with-msg:kinematic_messages instead.")))

(cl:ensure-generic-function 'joint_type-val :lambda-list '(m))
(cl:defmethod joint_type-val ((m <kinematic_messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:joint_type-val is deprecated.  Use ignition_telemetry_with-msg:joint_type instead.")
  (joint_type m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <kinematic_messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:angle-val is deprecated.  Use ignition_telemetry_with-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'angle_y-val :lambda-list '(m))
(cl:defmethod angle_y-val ((m <kinematic_messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:angle_y-val is deprecated.  Use ignition_telemetry_with-msg:angle_y instead.")
  (angle_y m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <kinematic_messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:angular_velocity-val is deprecated.  Use ignition_telemetry_with-msg:angular_velocity instead.")
  (angular_velocity m))

(cl:ensure-generic-function 'link_length-val :lambda-list '(m))
(cl:defmethod link_length-val ((m <kinematic_messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ignition_telemetry_with-msg:link_length-val is deprecated.  Use ignition_telemetry_with-msg:link_length instead.")
  (link_length m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<kinematic_messages>)))
  ...
  "ignition_telemetry_with/kinematic_messages")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'kinematic_messages)))
  "Returns string type for a message object of type 'kinematic_messages"
  "ignition_telemetry_with/kinematic_messages")
